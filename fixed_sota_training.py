#!/usr/bin/env python3
"""
Fixed Full State-of-the-Art Hybrid CNN-Transformer Training
Fixes the attribute conflict issue with HybridCNNTransformer
"""
...
from models.hybrid_model import create_hybrid_model  # Use factory function instead
...
def train_full_sota_model():
    ...
    # Build the full SOTA model using factory function
